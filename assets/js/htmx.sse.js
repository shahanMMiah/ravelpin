...
(function () {
    ...
    function createEventSourceOnElement(elt, retryCount) {
        ...
        source.onerror = function (err) {
            ...
            if (source.readyState === EventSource.CLOSED) {
                ...
                window.setTimeout(function () {
                    createEventSourceOnElement(
                        elt,
                        Math.min(7, retryCount + 1),
                    );
                }, timeout);
            }
        };
        ...
        queryAttributeOnThisOrChildren(elt, "sse-swap").forEach(
            function (child) {
        ...
        queryAttributeOnThisOrChildren(elt, "hx-trigger").forEach(
            function (child) {
